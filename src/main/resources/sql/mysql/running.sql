...
CREATE TABLE `activity_info` (
  ...
  `geohash_code` varchar(128) NOT NULL DEFAULT '' COMMENT 'geohash值',
...
CREATE TABLE `activity_participate` (
  ...
  `uuid` varchar(32) NOT NULL DEFAULT '' COMMENT '活动参与者uuid',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录创建时间',
...
CREATE TABLE `gps_info` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录创建时间',
  `last_update_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='地理信息表';

#
# Data for table "gps_info"
#
...
INSERT INTO `runner_user` VALUES (4,'','wangzhichao','wangzhichao','12ecb9c682171b040ae0f44095296c8465975ea3','7c0e8c9d0db01ea3','',0,NULL,NULL,NULL,'2015-05-26 17:46:27','2015-05-26 17:46:27');
